...
use crate::{
    config::{BIG_SRIDE, MAX_SYSCALL_NUM, PAGE_SIZE},
    loader::get_app_data_by_name,
    mm::{translated_phisical_address, translated_refmut, translated_str},
    task::{
...
pub fn sys_task_info(ti: *mut TaskInfo) -> isize {
    ...
    unsafe {
        *ti = TaskInfo {
            ...
            time: (get_time_us() - current_start_time()) / 1000,
        };
    }
    0
}
...
pub fn sys_set_priority(prio: isize) -> isize {
    ...
    inner.stride = BIG_SRIDE / prio as usize;
    prio
}
